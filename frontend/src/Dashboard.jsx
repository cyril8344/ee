                ...
                <div style={{ background: "#0a1020", borderRadius: 6, padding: "8px 10px", marginBottom: 10, fontSize: 11 }}>
                  ...
                  <div style={{ marginTop: 6, borderTop: `1px solid ${COLORS.border}`, paddingTop: 6 }}>
                            ...
                            return (
                              <div style={{ marginTop: 6, fontSize: 10 }}>
                                ...
                                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6, gap: 4 }}>
                                  ...
                                  <div style={{ flex: 1, background: "#ec489922", borderRadius: 4, padding: "4px 6px", textAlign: "center" }}>
                                    <div style={{ color: "#ec4899", fontWeight: 600, fontSize: 13 }}>
                                      {pretrainStats.false_ee_pct != null ? `${pretrainStats.false_ee_pct}%` : "—"}
                                    </div>
                                    <div style={{ color: COLORS.sub }}>false early exit</div>
                                    <div style={{ color: COLORS.sub, fontSize: 9 }}>early_exit → TP1 dans 12 bougies ({pretrainStats.false_ee_n ?? 0})</div>
                                  </div>
                                </div>
                                ...
                                {(() => {
                                  ...
                                  const stageLabels = {
                                    ...
                                    m15: "M15 EMA/RSI", atr_min: "ATR trop bas", atr_regime: "ATR régime bas",
                                    atr_max: "ATR trop haut", adx: "ADX H1 trop faible", adx_slope: "ADX H1 en baisse",
                    ...
                    <div style={{ marginTop: 8, borderTop: `1px solid ${COLORS.border}`, paddingTop: 8 }}>
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 4 }}>
                        <span style={{ fontSize: 9, color: COLORS.sub, flex: 1 }}>
                          Sizing drawdown — seuil % (vide = désactivé)
                        </span>
                        <input type="number" step="0.5" placeholder="5" value={wfDdSizingThreshold}
                          onChange={e => setWfDdSizingThreshold(e.target.value)}
                          style={{ width: 50, fontSize: 10, background: COLORS.bg, border: `1px solid ${COLORS.border}`,
                            borderRadius: 3, color: COLORS.text, padding: "2px 4px" }} />
                      </div>
                      <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 4 }}>
                        <span style={{ fontSize: 9, color: COLORS.sub, flex: 1 }}>
                          Sizing drawdown — facteur risk_pct (vide = 0.5 par défaut)
                        </span>
                        <input type="number" step="0.05" placeholder="0.5" value={wfDdSizingFactor}
                          onChange={e => setWfDdSizingFactor(e.target.value)}
                          style={{ width: 50, fontSize: 10, background: COLORS.bg, border: `1px solid ${COLORS.border}`,
                            borderRadius: 3, color: COLORS.text, padding: "2px 4px" }} />
                      </div>
                      <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 4 }}>
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 4 }}>
                        <span style={{ fontSize: 9, color: COLORS.sub, flex: 1 }}>
                          ↳ lookback pente (bougies M5, vide = défaut 5)
                        </span>
                        <input type="number" step="1" placeholder="5" value={wfEmaSlopeLookback}
                          onChange={e => setWfEmaSlopeLookback(e.target.value)}
                          style={{ width: 50, fontSize: 10, background: COLORS.bg, border: `1px solid ${COLORS.border}`,
                            borderRadius: 3, color: COLORS.text, padding: "2px 4px" }} />
                      </div>
                      <label style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 4, cursor: "pointer" }}>
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 4 }}>
                        ...
                        <input type="number" step="0.05" placeholder="0" value={wfBeBufferR}
                          onChange={e => setWfBeBufferR(e.target.value)}
                          style={{ width: 50, fontSize: 10, background: COLORS.bg, border: `1px solid ${COLORS.border}`,
                            borderRadius: 3, color: COLORS.text, padding: "2px 4px" }} />
                      </div>
                      <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 4 }}>
                        <span style={{ fontSize: 9, color: COLORS.sub, flex: 1 }}>
                          Early exit — délai en minutes (vide = 15, comportement actuel)
                        </span>
                        <input type="number" step="1" placeholder="15" value={wfEarlyExitOverride}
                          onChange={e => setWfEarlyExitOverride(e.target.value)}
                          style={{ width: 50, fontSize: 10, background: COLORS.bg, border: `1px solid ${COLORS.border}`,
                            borderRadius: 3, color: COLORS.text, padding: "2px 4px" }} />
                      </div>
                      <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 4 }}>
                      ...
                      {(wfAdxOverride !== "" || wfRsiLongOverride !== "" || wfRsiShortOverride !== "" || wfAtrMinOverride !== "" || wfTrendBiasOverride !== "" || wfAdxRegimeOverride !== "" || wfAtrRegimeMaxOverride !== "" || wfDdSizingThreshold !== "" || wfDdSizingFactor !== "" || wfBadHoursOverride !== "" || obRequireBos || wfBeBufferR !== "" || obRequireLiquidity || wfEarlyExitOverride !== "" || wfAdxH1Override !== "" || emaSlopeFilter || wfEmaSlopeLookback !== "") && (
